    ...
    >
      <div class="boxed-container w-full">
        <div class="d-flex align-center mx-6">
          ...
          >Login : {{ $store.state.userInfo.userName ? $store.state.userInfo.userName : '' }} / {{ $store.state.userInfo.loginId ? $store.state.userInfo.loginId : '' }}</strong>
...
import {
  mdiMagnify, mdiBellOutline, mdiGithub, mdiAccountCheck,
} from '@mdi/js'
